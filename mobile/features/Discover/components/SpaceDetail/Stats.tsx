...
const Stats = () => {
  ...
  return (
    <View style={{ paddingLeft: 10, paddingRight: 10, flexDirection: 'row', alignItems: 'center', marginBottom: 5 }}>
      <TouchableOpacity style={{ width: '33%', paddingRight: 3 }}>
        <View
          style={{
            padding: 15,
            alignItems: 'center',
      ...
      <TouchableOpacity style={{ width: '33%', paddingRight: 3, paddingLeft: 3 }}>
        <View
          style={{
            padding: 15,
            alignItems: 'center',
      ...
      <TouchableOpacity style={{ width: '33%', paddingLeft: 3 }}>
        <View
          style={{
            padding: 15,
            alignItems: 'center',
        ...
        >
          <Text style={{ color: 'white', fontSize: 20, marginBottom: 10 }}>Tags</Text>
